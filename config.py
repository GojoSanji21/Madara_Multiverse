...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7954594133:AAF33CF4XD-dM0YvryogOESH2OcqSANZUaY")
...
PICS = (os.environ.get("PICS", "https://ibb.co/vCt4FmSb")).split() #Required
